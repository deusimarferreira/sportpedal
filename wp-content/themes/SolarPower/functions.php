<?php
	...
	<style type="text/css">
	.login h1 a {
	background-image:url('.get_bloginfo('http://sportpedal.com/wp-content/themes/SolarPower').'/Logo_Adm_Site.png) !important;

...
<?php  } ?>
    ...
    <div id="footer">
        ...
        <?php /* 
            ...
            You can buy this theme without footer links online at http://newwpthemes.com/buy/?theme=solarpower
        */ ?>
        
        <div id="credits"><a href="http://wordpress.org/"><strong></strong></a> <?php do_action("srb_theme_links"); ?></div><!-- #credits -->

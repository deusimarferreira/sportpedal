    ...
    <div id="main">
        ...
        <div id="content">
            ...
            <h2 class="page-title"><?php
               ...
               if (is_day()) { printf( __( ' <span>%s</span>', 'themater' ), get_the_date() ); 
                
                /* If this is a monthly archive */ 
                } elseif (is_month()) { printf( __( ' <span>%s</span>', 'themater' ), get_the_date('F Y') );
                  
                /* If this is a yearly archive */ 
                } elseif (is_year()) { printf( __( '<span>%s</span>', 'themater' ), get_the_date('Y') );
